...
{
    public partial class QuantsQuestions : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            DisplayQuestions("Quants");
        }
        ...
        private void DisplayQuestions(string selectedSubject)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query = "SELECT TOP 10 QuestionText, Marks, Level FROM Questions " +
                       ...
                       "WHERE Subjects.SubjectName = @SubjectName ORDER BY NEWID()"; // Randomly select 10 questions
