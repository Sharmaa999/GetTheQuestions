...
{
    public partial class ChemistryAdvanceQuestions : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            DisplayQuestions("ChemistryAdvance");
        }
        private void DisplayQuestions(string selectedSubject)
        {
            string connectionString = "Data Source=MUM-LAP-700373\\SQLEXPRESS01;Initial Catalog=SchoolDatabase;Integrated Security=True"; // Replace with your actual connection string
